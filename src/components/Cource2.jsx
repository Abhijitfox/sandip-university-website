...
export default function BdesSection2() {
  return (
    <section className="w-full bg-gradient-to-br from-[#f7f7f7] to-[#ffffff] py-10 px-5 md:px-5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-star mt-5">
...
Master of Science
          ...
          <p className="text-xl text-gray-600 font-medium mb-10">
            (2 Years | Full-Time Professional Program)
          </p>
        ...
        >
          <div className="rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden border border-gray-200 bg-white">
            <img
              src="https://mywebsite.blog/sandipuniversity/02/assets/images/DSC_4575.jpg"
              alt="B.DES Course"
