...
export default function Cource1() {
    const [openModal, setOpenModal] = useState(false);

  return (
        <>

    <section className="w-full bg-gradient-to-br from-[#f7f7f7] to-[#ffffff] py-16 md:py-20 px-4 sm:px-6 md:px-12">
      
      {/* Heading */}
      <h4 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-700 mb-4 text-left leading-tight">
        Programs Offered
      </h4>

      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start mt-10 md:mt-16">
        ...
        >
          ...
          {/* Glow */}
          <div className="absolute -bottom-10 -left-10 w-32 h-32 sm:w-40 sm:h-40 bg-red-500/20 rounded-full blur-3xl"></div>
        </motion.div>
        ...
        >
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white bg-opacity-80 backdrop-blur-lg border border-gray-200 shadow-[0_8px_30px_rgba(0,0,0,0.1)] mb-8 sm:mb-10">
            ...
            <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
              ✔ Or completed a 10th + Diploma in any relevant stream from a
