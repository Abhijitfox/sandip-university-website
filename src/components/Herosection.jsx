...
export default function Herosection() {
  ...
  {/* DARK GRADIENT OVERLAY FOR TEXT VISIBILITY */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 
                      grid lg:grid-cols-12 gap-10 items-center pt-24 pb-10">
            ...
            <div className="relative z-10 text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold leading-snug drop-shadow-xl">
                ...
                <motion.span
                  ...
                  className="block text-2xl md:text-3xl font-light tracking-wide mt-1 drop-shadow-2xl"
                >
                  School of Design
                </motion.span>
              </h1>
              ...
              <p className="text-sm md:text-lg text-gray-200 mt-4 leading-relaxed drop-shadow-lg">
                Apply for the B.Design Programme focused on creativity,
                innovation & hands-on practical training.
              </p>
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-transparent opacity-40 rounded-3xl" />
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7 }}
          className="lg:col-span-5 col-span-12 w-full flex justify-end items-center"
        >
          <div className="bg-white/20 backdrop-blur-xl shadow-2xl rounded-2xl p-6 w-full max-w-md border border-white/10">

            <h2 className="text-xl font-semibold text-white text-center mb-4 animate-pulse">
              Apply Now
            </h2>
 ...
 <form className="grid grid-cols-1 gap-3 text-sm">
              ...
              <button className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 
