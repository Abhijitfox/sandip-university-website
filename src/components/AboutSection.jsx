    ...
    <section className="bg-gray-50 text-gray-800 py-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-6">
          <div className="p-8 rounded-3xl bg-gradient-to-br from-teal-50 to-indigo-50 shadow-lg">
...
Sandip University is a premier educational institution dedicated
            ...
            <div className="mt-8 flex gap-4">
              ...
              <button className="px-4 py-3 rounded-lg border border-gray-300 text-sm hover:bg-gray-100 transition flex items-center gap-2">
                Request Brochure
                <FontAwesomeIcon icon={faArrowRight} />
              </button>
            </div>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl bg-white">
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="px-3 py-2 bg-white/20 rounded hover:bg-white/30 transition text-sm flex items-center gap-2">
                  View Gallery
                  <FontAwesomeIcon icon={faArrowRight} />
                </button>
              </div>
